# utils/standalone_gps.py
"""
Standalone GPS extraction that can be used without ADK dependencies.
This is a simplified version that only extracts GPS coordinates.
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python utils/standalone_gps.py <image_path>")
        print("Example: python utils/standalone_gps.py tests/sample_images/image.png")
        sys.exit(1)
    ...
    try:
        ...
        # Extract GPS coordinates
        result = process_image_location(image_base64, "base64")
        
        print(f"\n🧪 GPS Extraction Test Results:")
